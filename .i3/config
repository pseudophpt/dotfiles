...
bindsym $mod+d exec bash ~/rofi.sh
...
bar {
    status_command /home/fin/bumblebee-status/bumblebee-status -m kernel disk:home memory cpu spacer title brightness amixer bluetooth datetime -t gruvbox-powerline
	position top
...
#                                  border  backgr. text
        focused_workspace   $focused    $focused    $i3_background
        active_workspace    $focused    $focused    $i3_background
        inactive_workspace  $inactive   $inactive   $i3_text
        urgent_workspace    $urgent     $urgent     $i3_background
    }
}
